...
public class CatalogService
{
    ...
    // Caldwell catalog: OpenNGC name → Caldwell number (C1–C109)
    private static readonly Dictionary<string, int> CaldwellMap = new()
    {
        ...
        // C9 = Sh2-155 — not in NGC/IC
        { "NGC0663",  10 }, { "NGC7635", 11 }, { "NGC6946", 12 }, { "NGC0457", 13 },
        { "NGC0869",  14 }, // Double Cluster (h Per); NGC 884 also C14
        { "NGC6826",  15 }, { "NGC7243", 16 }, { "NGC0147", 17 }, { "NGC0185", 18 },
        { "IC5146",   19 }, { "NGC7000", 20 }, { "NGC4449", 21 }, { "NGC7662", 22 },
        { "NGC0891",  23 }, { "NGC1275", 24 }, { "NGC2419", 25 }, { "NGC4244", 26 },
        { "NGC6888",  27 }, { "NGC0752", 28 }, { "NGC5005", 29 }, { "NGC7331", 30 },
        { "IC0405",   31 }, { "NGC4631", 32 }, { "NGC6992", 33 }, { "NGC6960", 34 },
        { "NGC4889",  35 }, { "NGC4559", 36 }, { "NGC6885", 37 }, { "NGC4565", 38 },
        { "NGC2392",  39 }, { "NGC3626", 40 },
        // C41 = Melotte 25 (Hyades) — not in OpenNGC
        ...
        { "NGC4609",  98 },
        // C99 = Coalsack (dark nebula) — not in OpenNGC
        { "IC2944",   100 }, { "NGC6744", 101 }, { "NGC2070", 102 },
        { "NGC3195",  109 },
    };
    ...
    private IReadOnlyList<DeepSkyObject> LoadCatalog()
    {
        var assembly = Assembly.GetExecutingAssembly();
        const string resourceName = "AstroPlanner.Assets.Data.NGC.csv";
    ...
    private static bool TryParseRa(string ra, out double degrees)
    {
        ...
        if (!double.TryParse(parts[1], NumberStyles.Float, CultureInfo.InvariantCulture, out double m)) return false;
    ...
    // CsvHelper record type — must match OpenNGC header exactly
