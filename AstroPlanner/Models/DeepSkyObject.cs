...
/// <summary>
/// An entry from the OpenNGC catalog (NGC or IC object),
/// optionally cross-referenced with Messier and Caldwell catalogs.
/// </summary>
public class DeepSkyObject
{
    /// <summary>Primary catalog name, e.g. "NGC0224" or "IC0342".</summary>
